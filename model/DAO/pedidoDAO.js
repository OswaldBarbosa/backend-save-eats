...
//traz pedido de um restaurante especifico
const selectAllDetalhesPedidoByIdRestauranteFiltroData = async function (idRestaurante,dataInicial,dataFinal) {
    ...
    INNER JOIN tbl_cliente ON tbl_pedido.id_cliente = tbl_cliente.id
    WHERE tbl_pedido.id_restaurante = ${idRestaurante}
    AND tbl_pedido.data_pedido BETWEEN ${dataInicial} AND ${dataFinal}
    ORDER BY tbl_pedido.numero_pedido DESC;`
...
module.exports = {
    ...
    selectAllDetalhesPedidoByIdRestauranteFiltroData
}